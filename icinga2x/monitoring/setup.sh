...
pushd /tmp
wget -O "html-xml-utils.rpm" "ftp://ftp.pbone.net/mirror/ftp5.gwdg.de/pub/opensuse/repositories/home:/TrevorBl/CentOS_CentOS-6/x86_64/html-xml-utils-6.9-4.1.x86_64.rpm" && yum install -q -y html-xml-utils.rpm
popd
